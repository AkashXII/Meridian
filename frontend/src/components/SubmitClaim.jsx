...
export default function SubmitClaim({ authToken, setAuthToken, currentScreen, setCurrentScreen, setClaimResult }) {
...
<header className="bg-surface-container-lowest border-b border-outline-variant w-full">
  <div className="relative flex items-center w-full px-margin-desktop py-4">
    ...
    >
      ...
      <main className="flex-grow w-full max-w-container-max mx-auto px-margin-desktop py-12">
        <div className="max-w-2xl mx-auto">
          <div className="mb-stack-lg">
            <h1 className="font-display-lg text-display-lg text-on-surface mb-stack-sm">Submit a Claim</h1>
          ...
          <form className="space-y-stack-lg" onSubmit={handleSubmit}>
            <div className="flex flex-col space-y-stack-sm">
              <label className="font-label-md text-label-md text-on-surface uppercase tracking-wider" htmlFor="claim-description">
                Describe your claim
              </label>
              <textarea
      ...
      <footer className="bg-surface-container w-full border-t border-outline-variant mt-auto">
